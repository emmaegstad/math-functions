...
export function sumAndMultiplyThreeNumbers(a, b, c) {
    ...
    const productAB = multiply(a, b)[0];
    const productABC = multiply(productAB, c)[0];
    const str1 = `${a} and ${b} and ${c} sum to ${sumABC}.`;
    const str2 = `The product of ${a} and ${b} and ${c} is ${productABC}.`;
    return [sumABC, productABC, str1, str2];
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    const arrSum1 = sum(sumArr[0], sumArr[1])[0];
    const arrSum2 = sum(arrSum1, sumArr[2])[0];
    const arrStr = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${arrSum2} is their sum.`;
    return [arrSum2, arrStr];
}
...
export function multiplyArrayWithThreeNumbers(multArr) {
    //eslint-disable-line
    const arrProd1 = multiply(multArr[0], multArr[1])[0];
    const arrProd2 = multiply(arrProd1, multArr[2])[0];
    const arrProdStr = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${arrProd2}.`;
    return [arrProd2, arrProdStr];
}
